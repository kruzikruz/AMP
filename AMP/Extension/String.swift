...
extension String {
    ...
    func htmlAttributedString() -> String {
        guard let data = self.data(using: String.Encoding.utf16, allowLossyConversion: false) else { return self }
...
//            preconditionFailure("Take a look to your format")
        ...
        dateFormatterTo.dateFormat = DATE_FORMAT
    ...
    /// Returns a new string made by replacing all HTML character entity references with the corresponding character.
      ...
      func decodingHTMLEntities() -> String {
        ...
        result = result.replacingOccurrences(of: "<em>", with: "").replacingOccurrences(of: "</em>", with: "")
        return result
      }
    }
